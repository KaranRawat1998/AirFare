...
logging.basicConfig(filename='Internship/logfiles/test.log',level=logging.INFO,
...
def retrieve():
    ...
    :return: Render database.html Template
    """
    logging.info('render database.html')
    heading =("Index","Airline","Date_of_Journey","Source","Destination","Route","Dep_Time","Arrival_Time","Duration","Total_Stops","Additional_Info","Price")
    logging.info('calling database class connector')
    data= Connector()
    return render_template('database.html', heading=heading, data=data.Database())
